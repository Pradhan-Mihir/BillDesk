<?php
	...
	if(isset($_POST['edit_fetch']))
	{
		if(isset($_POST['id']))
		{
			$fetchSql = "select * from tbl_cashmemo_detail where cashmemo_id = '".$_POST['id']."'";
			$result_sql = mysqli_query($con,$fetchSql);			
			
			while($row = mysqli_fetch_array($result_sql))
			{
				$cashmemo_detail_id = $row["cashmemo_detail_id"];
				...
				$response[] = array ("cashmemo_detail_id" => $cashmemo_detail_id , "product_id" => $product_id , "unit_id" => $unit_id , "rate" => $rate , "qty" => $qty ,"disc_per" => $disc_per ,"gstslab_id" => $gstslab_id ,"disc_amt" => $disc_amt , "serial_no" => $serial_no , "batch_no" => $batch_no);
			}		
		}
		else
		{
	...
	//cashmemo_detail_delete.php delete_product_while_edit
	else if(isset($_POST['edit_delete_detail']))
	{
		if(isset($_POST['id']))
		{
			$sql_inv_fetch = "select product_id , qty from tbl_cashmemo_detail where cashmemo_detail_id = '".$_POST['id']."'";
			...
			$deleteSql = "delete from tbl_cashmemo_detail where cashmemo_detail_id = '".$_POST['id']."' ";
	...
	//cashmemo_party_search.php fnc_state_change() , fnc_party()
	...
	//cashmemo_product_fetch.php fnc_unit()
	...
	else if(isset($_POST['inv_delete']))
	{
		if(isset($_POST['id']))
		{
			$sql_inv_delete = "SELECT product_id , qty from tbl_cashmemo_detail where cashmemo_id = '".$_POST['id']."'" ;
	...
	else if(isset($_POST['edit_unit_fetch']))
	{
		if(isset($_POST['id']))
		{
			$fetchSql = "select * from tbl_cashmemo_detail where cashmemo_detail_id = '".$_POST['id']."'";
			$result_sql = mysqli_query($con , $fetchSql);
			while($row = mysqli_fetch_array($result_sql))
			{
				$unit_id = $row['unit_id'];
