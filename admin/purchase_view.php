						...
						$counter = 0;
						  ...
						  {?>
							...
							<td class="text-nowrap">
							  <a href="purchase.php?id=<?php echo base64_encode($row['purchase_invoice_id']);?>" class='btn_edit' data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-inverse m-r-10"></i> </a>
							  <a href="" class='btn_delete' id='<?php echo $row['purchase_invoice_id'];?>' data-toggle="tooltip" data-original-title="Close"> <i class="fa fa-close text-danger"></i> </a>
							</td>
		...
		$('.btn_delete').click(function(e)
		{
			...
			if(confirm("Are you sure you want to delete this?"))
			{
				$.ajax({ url: 'purchase_ajax.php',
						 data: {'id': purchase_invoice_id, 'inv_delete': 1},
						 type: 'post',
