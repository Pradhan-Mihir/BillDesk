...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2022 at 11:26 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `viewPurchaseinvoice` ()  BEGIN
	select pr.* from tbl_purchase_invoice pr join tbl_company com where com.company_id = pr.company_id and com.is_default = 1;
END$$
...
(4, 4, 3, '101', 2, 0, 'GUJARAT', '2022-01-08', 0, 'cvbnm', '2880.00', '50.00', b'0', '0.00', '2930.00', '2930.00', 0, '', b'0'),
(5, 4, 3, '123asd', 3, 0, 'GOA', '2022-01-08', 0, '', '4550.00', '200.00', b'0', '0.00', '4750.00', '4750.00', 0, '', b'0');
...
--
ALTER TABLE `tbl_purchase_invoice`
  MODIFY `purchase_invoice_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
