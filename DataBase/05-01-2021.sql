...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2022 at 10:36 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `fetchPurchase_invoice` (IN `PROID` BIGINT(20))  BEGIN
...
(1, 4, 6, 'ABC123PQR', 'V101', 'Veg Burger', 3, 'cvb', 1, '69.00', 'Including Gst', '100.00', 'Excluding Gst', '100.000', '100.00', 'asdfghjkl', '50.000', 'surat', '2021-12-20', 'burger989814.png'),
(5, 4, 6, '123PQR456', 'B102', 'Non-veg Burger', 3, 'nvb', 14, '79.00', 'Including Gst', '89.00', 'Including Gst', '100.000', '89.00', 'non veg burger with meat', '50.000', 'surat', '2021-12-23', 'burger755322.png'),
(6, 4, 4, '456XYZ789', 'P101', 'Margeta Pizza', 3, 'pm', 1, '99.00', 'Including Gst', '120.00', 'Including Gst', '50.000', '120.00', 'margerita with extra cheese', '50.000', 'surat', '2021-12-23', 'margerita756610.jpg'),
(7, 4, 2, '980DFG021', 'P102', 'Burn to hell', 3, 'pbth', 1, '110.00', 'Including Gst', '120.00', 'Including Gst', '100.000', '120.00', '', '100.000', 'surat', '2021-12-23', 'burn to hell825075.jpg'),
(8, 4, 2, 'ASDFGHJKL', 'S101', 'Pepsi', 3, 'PSp', 1, '50.00', 'Including Gst', '90.00', 'Including Gst', '50.000', '90.00', '', '50.000', 'surat', '2021-12-24', 'pepsi726713.jpg'),
...
(2, 4, 1, '', 1, 0, 'NULL', '0000-00-00', 0, '', '0.00', '0.00', b'0', '0.00', '0.00', '0.00', 0, '', b'0');
...
--
ALTER TABLE `tbl_purchase_invoice`
  MODIFY `purchase_invoice_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
